...
//===============================================================================
  ...
  struct FAULTDIR_BITS {            // bits   description
    ...
    Uint32 FLT3_DIR:1;              // 3      [pin=64]FAULT[3] Pin Direction
  ...
  struct FAULTIN_BITS {             // bits   description
    ...
    Uint32 FLT3_IN:1;               // 3      [pin=64]FAULT[3] Input Value
  ...
  struct FAULTOUT_BITS {            // bits   description
    ...
    Uint32 FLT3_OUT:1;              // 3      [pin=64]FAULT[3] pin output data
  ...
  struct FAULTINTENA_BITS {         // bits   description
    ...
    Uint32 FLT3_INT_EN:1;           // 3      [pin=64]FAULT[3] pin interrupt enable
  ...
  struct FAULTINTPOL_BITS {         // bits   description
    ...
    Uint32 FLT3_INT_POL:1;          // 3      [pin=64]FAULT[3] pin interrupt polarity
  ...
  struct FAULTINTPEND_BITS {        // bits   description
    ...
    Uint32 FLT3_INT_PEND:1;         // 3      [pin=64]FAULT[3] pin interrupt flag
