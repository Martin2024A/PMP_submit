...
struct FIRQPR_BITS {                   // bits   description
   ...
   Uint32 FIRQ_UART2_TX:1;             // 8      [pin=64]Interrupt 8, UART2 TX buffer empty
   Uint32 FIRQ_UART2_RX:1;             // 7      [pin=64]Interrupt 7, UART2 RX buffer has a byte
   ...
   Uint32 FIRQ_EXT_INT:1;              // 1      [pin=64]Interrupt 1, Interrupt on one or all external input pins
...
struct INTREQ_BITS {                     // bits   description
   ...
   Uint32 INTREQ_UART2_TX:1;             // 8      [pin=64]Interrupt 8, UART2 TX buffer empty
   Uint32 INTREQ_UART2_RX:1;             // 7      [pin=64]Interrupt 7, UART2 RX buffer has a byte
   ...
   Uint32 INTREQ_EXT_INT:1;              // 1      [pin=64]Interrupt 1, Interrupt on one or all external input pins
...
struct REQMASK_BITS {             // bits   description
   ...
   Uint32 REQMASK_UART2_TX:1;             // 8      [pin=64]Interrupt 8, UART2 TX buffer empty
   Uint32 REQMASK_UART2_RX:1;             // 7      [pin=64]Interrupt 7, UART2 RX buffer has a byte
   ...
   Uint32 REQMASK_EXT_INT:1;              // 1      [pin=64]Interrupt 1, Interrupt on one or all external input pins
