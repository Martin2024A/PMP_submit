...
//  1.01 | 16 Jun 2015 | AC   | Added LFO Trim
//       |             |      |
//
...
//-----------------------------------------------------------------------------
  ...
  struct IOMUX_BITS {          // bits   description
    ...
    Uint32 TPWM0_MUX_SEL:1;    // 9      TPWM0 Pins Mux Control
  ...
  struct CLKGATECTRL_BITS {   // bits    Description
    ...
    Uint32 DTC_CLK_EN:1;      // 22      DTC Clock Enable
  ...
  struct DTCUARTSEL_BITS {     // bits   Description
    ...
    Uint32 UART1_RX_SEL:1;     // 1      UART1 Receive Pin Control
  ...
  // Clock_SEL Register
  //-----------------------------------------------------------------------------
  struct LFOCLKSEL_BITS {       // bits      Description
    Uint32 rsvd0:28;            // 31:4      Reserved
    Uint32 WD_CLK_SEL:1;        // 3         WD CLK SEL
    Uint32 RTC_CLK_SEL:1;       // 2         RTC CLK SEL
    Uint32 rsvd1:2;             // 1:0
  };
  union LFOCLKSEL_REG {
    Uint32                   all;
    struct LFOCLKSEL_BITS        bit;
  };
  //=============================================================================
  ...
  int32 RESERVED7; //reserved for TI use
  union DTCUARTSEL_REG    DTCUARTSEL;
  int32 RESERVED8; //reserved for TI use
  union LFOCLKSEL_REG     LFOCLKSEL;
  };

  //-----------------------------------------------------------------------------
  // ANALOG MISC Module External References & Function Declarations:
  //-----------------------------------------------------------------------------
