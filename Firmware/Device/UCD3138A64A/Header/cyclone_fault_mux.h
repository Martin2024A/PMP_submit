...
extern "C" {
  ...
  struct FAULTMUXINTSTAT_BITS {     // bits   description
    Uint32 rsvd0:14;                // 31:16  Reserved
    Uint32 XTAL_FAIL:1;             // 17     XTAL Failure Interrupt Status
  ...
  //-----------------------------------------------------------------------------
  // XTAL Fail Detect Register
  //-----------------------------------------------------------------------------
  struct XTALFAILDET_BITS {                 // Bits   Description
    Uint32 rsvd0:20;                        // 31:6   Reserved
    Uint32 XTAL_FAIL_UPPER_THRESH:5;        // 11:7   XTAL Fail Upper Threshold
    Uint32 XTAL_FAIL_LOWER_THRESH:5;        // 6:2    XTAL Fail  Lower Threshold
    Uint32 XTAL_FAIL_INT_EN:1;              // 1      XTAL Fail Interrupt Enable
    Uint32 XTAL_DETECT_EN:1;                // 0      XTAL Fail Detect Enable
  };
  union XTALFAILDET_REG {
    Uint32                   all;
    struct XTALFAILDET_BITS   bit;
  };
  //=============================================================================
  ...
  struct FAULT_MUX_REGS {
    ...
    union XTALFAILDET_REG       XTALFAILDET;       // XTAL Fail Detect Register
  };
