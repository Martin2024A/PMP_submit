...
struct FIRQPR_BITS {                   // bits   description
   ...
   Uint32 FIRQ_TMR_CAPT1_DTC:1;        // 19     Interrupt 19, 24-bit Timer Capture 1 interrupt + DTC
...
struct INTREQ_BITS {                     // bits   description
   ...
   Uint32 INTREQ_TMR_CAPT1_DTC:1;        // 19     Interrupt 19, 24-bit Timer Capture 1 interrupt + DTC
...
struct REQMASK_BITS {             // bits   description
   ...
   Uint32 REQMASK_TMR_CAPT1_DTC:1;        // 19     Interrupt 19, 24-bit Timer Capture 1 interrupt + DTC
